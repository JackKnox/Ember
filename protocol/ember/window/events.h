...
/**
 * @brief Creates an endpoint that receives events generated by the desktop.
 *
 * @param desktop Desktop connection to receive events from.
 *
 * @return A valid event endpoint on success, or EM_ENDPOINT_INVALID on failure.
 */
em_endpoint emwin_desktop_open_events(emwin_desktop* desktop);
