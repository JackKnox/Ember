 ...
 */
b8 emwin_key_down(emwin_input* input, emwin_key_code code);
 ...
 */
b8 emwin_mouse_down(emwin_input* input, emwin_mouse_code code);
 ...
 * @param input Pointer to the input system.
 */
vec2 emwin_mouse_position(emwin_input* input);
 ...
 * @param input Pointer to the input system.
 */
vec2 emwin_mouse_scroll(emwin_input* input);
 ...
 */
void emplat_set_joystick_connect_callback(emwin_input* input, PFN_joystick_connection callback, void* user_data);
 ...
 */
const emwin_joystick_device* emplat_get_joystick_device(emwin_input* input, emwin_joystick_id id);
 ...
 */
void emplat_get_joystick_state(emwin_input* input, u32 id, emwin_joystick_state* out_state);