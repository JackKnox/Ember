...
VkResult vulkan_command_buffer_allocate_and_begin_single_use(
    ...
    vulkan_queue* owner,
    vulkan_command_buffer* out_command_buffer) {
    EM_ASSERT(context != NULL && owner != NULL && out_command_buffer != NULL && "Invalid arguments passed to vulkan_command_buffer_allocate_and_begin_single_use");
...
VkResult vulkan_command_buffer_end_single_use(
    vulkan_context* context,
    vulkan_command_buffer* command_buffer) {
    EM_ASSERT(context != NULL && command_buffer != NULL && "Invalid arguments passed to vulkan_command_buffer_end_single_use");
